...
import com.allured.test.lesson05.model.Member;
...
public class Lesson05Controller {
	...
	@GetMapping("/test01")
	public String test01View() {
		return "lesson05/test01";
	}
	
	@GetMapping("/test02")
	public String test02View(Model model) {
	...
	@GetMapping("test03")
	public String test03View(Model model) {
	...
	@GetMapping("/test04")
	public String test04View(Model model) {
